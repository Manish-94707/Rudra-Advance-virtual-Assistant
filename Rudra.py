...
class Widget:
    ...
    def clicked(self):
        ...
        if 'wikipedia'in query:
            ...
            speak("always ready to help you manish sir")
            ...
            speak("thats not me sir....i am Rudra")

        elif 'hey siri' in query.lower():
            speak("i am Rudra sir,how can you forget something which is created by you sir") 
